...
class Appointment extends Admin_Controller
{
		...
		public function postToApi()
	{
					...
					$payload = array(
									...
									"Tin No" => "27100001232V",
									"CST No" => "27100001232C",
									"GSTIN" => "27AALCA8446N1ZY",
									"Term of Payment" => "30 Days",
									"Other Reference" => "Sales Person - A",
									"Terms of Delivery" => "Ex-Works",
									"Dispatch Through" => "Local Tempo",
									"Destination" => "Bhiwandi Godown",
									"Order No" => "ORD - AA12112",
									"Due On" => "25-12-2022",
									"Item Name" => "Product - 3",
									...
									"Discount %" => 5,
									"Amount" => 1368,
									"Sales Ledger" => "Sales GST Local @ 18%",
									"Other Charges_1 Amount" => 40,
									"Other Charges_1 Ledger" => "Transport Charges",
									"Other Charges_2 Amount" => -100,
									"Other Charges_2 Ledger" => "Discount",
									"SGST Amount" => 117.72,
									"SGST Ledger" => "SGST",
									"CGST Amount" => 117.72,
									"CGST Ledger" => "CGST",
									...
									"Godown" => "Bhiwandi",
									"Narration" => "Being Order Booked Againts your Email Dated DD/MM/YYYY"
													),
													array(
																	"Date" => "22-12-2022",
																	"Voucher Number" => "SO - 1",
					...
					// Initialize cURL
					$ch = curl_init('https://api.excel2tally.in/api/User/SalesOrder');
					...
					curl_setopt($ch, CURLOPT_HTTPHEADER, array(
									'X-Auth-Key: live_0275058d07eb474988c61796c8df32d1',
									'Template-Key: 3',
									'CompanyName: Ankur',
									'version: 3' // Use 3 only for TallyPrime Rel 3x and above
					));
...
// Output JavaScript code to log the API response to the browser's console
//echo '<script>console.log("API Response: ' . addslashes($response) . '");</script>';
// PHP code to pass API response data to JavaScript
//echo '<script>';
//echo 'var apiResponse = ' . json_encode($response) . ';';
//echo 'console.log("API Response:", apiResponse);';
//echo '</script>';
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
			...
			//console.log('HIII');
		   $this->postToApi(); // Call to the method using $this
			//echo '<script>';

			//echo 'console.log("API Called");';
