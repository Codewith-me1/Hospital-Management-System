            ...
            <form action="<?php echo site_url('admin/admin/updateandappCode') ?>" method="POST" id="andapp_code">
                <div class="modal-body andapp_modal-body">
                    ...
                    <div class="form-group">
                        <label class="ainline"><span>Phoenix Purchase Code for Android App ( <a target="_blank" href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-"></a> )</span></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Your Email registered </label>
