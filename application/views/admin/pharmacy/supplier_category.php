<div class="content-wrapper">  
    ...
    <thead>
        <tr>
            ...
            <th>GSTN</th> <!-- New column for GSTN -->
            <th><?php echo $this->lang->line('address'); ?></th>
            <th class="text-right noExport"><?php echo $this->lang->line('action'); ?></th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($supplierCategory as $supplier) { ?>
            <tr>
                ...
                <td><?php echo $supplier['gstn']; ?></td> <!-- Display GSTN for each supplier -->
                ...
                <div class="modal-body pt0 pb0">    
                    <div class="ptt10">
                        <div class="row">
							...
							<div class="col-md-6">
    <div class="form-group">
        <label for="exampleInputEmail1">GSTN</label>
        <input autofocus="" name="gstn" placeholder="" type="text" class="form-control"  value="<?php
        if (isset($result)) {
            echo $result["gstn"];
        }
        ?>" />
