        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-danger">
                    Phoenix HiS may not work properly because ONLY_FULL_GROUP_BY is enabled, consult with Phoenix Support to disable ONLY_FULL_GROUP_BY in sql_mode configuration.
                </div>
            <?php } 
                $show=false;
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 col20" title="<?php echo $this->lang->line('blood_bank_income'); ?>">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/bloodbank/issue') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Blood Bank Income</span>
                                    <span class="info-box-number"><?php
